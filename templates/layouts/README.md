...
| `frontend_slides_bold` | Special | Design-forward HTML slide aesthetics, creative business decks, product stories, research readouts needing stronger taste | Mixed editorial palette `#101521` `#F6F1E7` `#245BFF` `#E9FF36` `#FF6B4A` | Frontend Slides-inspired, editorial, bold, non-generic |
...
| `frontend_slides_bold` | PPT-safe translation layer for Frontend Slides-style design directions; use with `templates/frontend_slides/design_catalog.json` and `scripts/template_recommender.py` |
