#!/usr/bin/env python3
"""
PPT Studio - Examples Index Generator
...
def generate_examples_index(examples_dir: str = 'examples') -> str:
    ...
    content = []
    content.append("# PPT Studio Example Projects Index\n")
    content.append("> This file is auto-generated by `skills/ppt-studio/scripts/generate_examples_index.py`\n")
    ...
    content.append("---\n")
    content.append(
        f"*Auto-generated on {datetime.now().strftime('%Y-%m-%d %H:%M:%S')} by PPT Studio*")
...
def main() -> None:
    ...
    print("=" * 80)
    print("PPT Studio - Examples Index Generator")
    print("=" * 80 + "\n")
