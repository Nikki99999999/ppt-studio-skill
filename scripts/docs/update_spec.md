...
```bash
python3 skills/ppt-studio/scripts/update_spec.py <project_path> <section>.<key>=<value>
```
...
python3 skills/ppt-studio/scripts/update_spec.py projects/acme_ppt169_20260301 primary=#0066AA

# explicit section.key form
python3 skills/ppt-studio/scripts/update_spec.py projects/acme_ppt169_20260301 colors.accent=#FF6B35

# change the deck-wide font family
python3 skills/ppt-studio/scripts/update_spec.py projects/acme_ppt169_20260301 \
