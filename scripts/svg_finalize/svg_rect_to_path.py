#!/usr/bin/env python3
"""
PPT Studio - SVG Rounded Rectangle to Path Tool
...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(
        description='PPT Studio - SVG Rounded Rectangle to Path Tool',
...
'''
    ...
    if not quiet:
        print("PPT Studio - SVG Rounded Rectangle to Path Tool")
        print("=" * 50)
